...
pub fn execute_programm_with_ast_custom_interpreter(interpreter: &mut Interpreter, programm: &str) -> Vec<ExpressionTypes> {
...
// Form: (...)
pub fn execute_form_with_ast_custom_interpreter(interpreter: &mut Interpreter, form: &str) -> ExpressionTypes {
